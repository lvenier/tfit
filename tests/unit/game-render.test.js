...
function installRenderGlobals(overrides = {}) {
  ...
  Object.assign(globalThis, {
    background_images: [asset('bg0'), asset('bg1'), asset('bg2')],
    arrayScore: [],
    back_button_image: asset('back'),
    BOLD: 'bold',
    calibrate_button_image: asset('calibrate'),
    CENTER: 'center',
    coef: 1,
    config_menu_button_image: asset('config'),
    cos: Math.cos,
    curMoves: [],
    duration_button_image: { 2: asset('duration60') },
    fight_button_image: asset('fight'),
    fight_menu_button_image: asset('fight-menu'),
    feet_position: 0,
    FRAME_RATE: 20,
    framerate_button_image: { 1: asset('fr20') },
    gameCurrentSeries: 1,
    gameDuration: 600,
    gameLengthIndex: 2,
    gameSeries: 3,
    ...
    level: 1,
    level_button_image: { 1: asset('medium') },
    lfeet_image: asset('left-foot'),
    loading_k: 0,
    loading_m: 0,
    logo_image: asset('logo'),
    map: (value, start1, stop1, start2, stop2) => start2 + ((value - start1) / (stop1 - start1)) * (stop2 - start2),
    menu: 2,
    menu_image: asset('menu'),
    ...
    opponent: 0,
    pad_button_image: asset('pad'),
    PI: Math.PI,
    radians: degrees => degrees * Math.PI / 180,
    rfeet_image: asset('right-foot'),
    ...
    score_max: 10,
    score_max_prev: 8,
    series_button_image: { 3: asset('series3') },
    shadow_button_image: asset('shadow'),
    shadow_focus: 1,

...
Face recognition loads these files from this directory only. Do not configure CDN, cloud, or API URLs for these paths if you want recognition to remain fully local.
